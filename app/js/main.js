...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('#site-logo-inner').find('img').attr( {src:'footerlogo.png',width:'195',height:'50'} );

              $('#logo-footer.style').find('img').attr( {src:'footerlogo.png',width:'195',height:'50'} );
              $('#logo-footer.style2').find('img').attr( {src:'footerlogo.png',width:'195',height:'50'} );
          }   
        };
